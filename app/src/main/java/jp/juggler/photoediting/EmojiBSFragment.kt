...
import jp.juggler.photoediting.PhotoApp.Companion.photoApp
...
class EmojiBSFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        private fun getEmojis(Context: PhotoApp?): ArrayList<String> {
            val convertedEmojiList = ArrayList<String>()
            for (emojiUnicode in convertedEmojiList)
            {
